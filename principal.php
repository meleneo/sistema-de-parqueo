											...
											<script>
												$('#btn_registrar_ticket<?php echo $id_map;?>').click(function(){
													...
													if (placa == ""){
														...
														alert('Debe de llenar este campo nombre del cliente');
							  ...
							  <div class="col">
									...
									<?php
										...
										foreach($datos_clientes as $datos_cliente){
											$id_ticket = $datos_cliente['nombre_cliente'];
									  ...
									  <div class="modal-dialog">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
												...
												<div class="col-sm-8">
												  <input type="text" style="text-transform: uppercase" value="<?php echo $placa_auto;?>" class="form-control" id="placa_buscar<?php echo $id_map;?>" disabled>
												</div>
